...
if __name__ == "__main__":
    ...
    save_wav(os.path.join(sounds_dir, "blip.wav"), generate_blip())
    save_wav(os.path.join(sounds_dir, "select.wav"), generate_select())
    save_wav(os.path.join(sounds_dir, "coin.wav"), generate_coin())
    save_wav(os.path.join(sounds_dir, "powerup.wav"), generate_powerup())
    save_wav(os.path.join(sounds_dir, "crash.wav"), generate_crash())
    save_wav(os.path.join(sounds_dir, "menu_music.wav"), generate_menu_music())
    save_wav(os.path.join(sounds_dir, "game_music.wav"), generate_game_music())
